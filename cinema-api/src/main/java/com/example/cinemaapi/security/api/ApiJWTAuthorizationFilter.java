package com.example.cinemaapi.security.api;
...
import static com.example.cinemaapi.security.SecurityConstants.*;

/**
 * .
 */
public class ApiJWTAuthorizationFilter extends BasicAuthenticationFilter {
    Logger logger = LoggerFactory.getLogger(ApiJWTAuthorizationFilter.class);
