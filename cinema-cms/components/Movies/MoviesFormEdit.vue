        ...
        <a-form-item label="Poster phim">
          <a-upload-dragger
            ...
            v-decorator="[
              'image',
              {
                initialValue: initialValues.image || null,
                valuePropName: 'file',
        ...
        <a-form-item label="Ngày khởi chiếu">
          <a-date-picker
            ...
            v-decorator="['releaseDate', {
                ...
                initialValue: initialValues.releaseDate && moment(initialValues.releaseDate, 'DD/MM/YYYY') || null
              }]"
          />
        </a-form-item>
      </a-col>
        ...
        <a-form-item label="Độ dài (phút)">
          <a-input-number
            ...
            v-decorator="['duration', {
                ...
                initialValue: initialValues.duration || null
              }]"
          />
        </a-form-item>
      </a-col>
        ...
        <a-form-item label="Thể loại">
          <a-select
            ...
            v-decorator="[
              ...
              {
                rules: [{ required: true, message: 'Bắt buộc!' }],
                initialValue: initialValues.categories && initialValues.categories.map(item => item.id) || []
              }
            ]"
            style="width: 100%"
            :filter-option="filterOption"
        ...
        <a-form-item label="Đạo diễn">
          <a-select
            ...
            v-decorator="[
              ...
              {
                rules: [{ required: true, message: 'Bắt buộc!' }],
                initialValue: initialValues.directors && initialValues.directors.map(item => item.id) || []
              }
            ]"
            style="width: 100%"
            :filter-option="filterOption"
        ...
        <a-form-item label="Diễn viên">
          <a-select
            ...
            v-decorator="[
              ...
              {
                rules: [{ required: true, message: 'Bắt buộc!' }],
                initialValue: initialValues.actors && initialValues.actors.map(item => item.id) || []
              }
            ]"
            style="width: 100%"
            :filter-option="filterOption"
        ...
        <a-form-item label="Ngôn ngữ">
          <a-select
            ...
            v-decorator="[
              ...
              {
                rules: [{ required: true, message: 'Bắt buộc!' }],
                initialValue: initialValues.languages && initialValues.languages.map(item => item.id) || []
              }
            ]"
            style="width: 100%"
            :filter-option="filterOption"
        ...
        <a-form-item label="Phụ đề">
          <a-select
            ...
            v-decorator="[
              ...
              {
                rules: [{ required: true, message: 'Bắt buộc!' }],
                initialValue: initialValues.subtitles && initialValues.subtitles.map(item => item.id) || []
              }
            ]"
            style="width: 100%"
            :filter-option="filterOption"
...
export default {
  ...
  data() {
    return {
      ...
      thumbPreviewUrl: this.initialValues.image || "",
